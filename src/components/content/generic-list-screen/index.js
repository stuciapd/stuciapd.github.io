  ...
  <Grid container className={classes.container} spacing={24}>
    ...
    <Grid item xs={12}>
      <Card
        ...
        content='A Level Group está contratando para a vaga de auxiliar de escritório, o contratado será responsável pela digitação de cadastro de clientes e atividades administrativas.'
      />
    </Grid>
    <Grid item xs={12}>
      <Card
        ...
        title='Atendente'
        content='A Neoformula contrata atendentes que irá atuar com o atendimento ao cliente, com a apresentação dos produtos e com a organização de prateleiras.'
      />
    </Grid>
    <Grid item xs={12}>
      <Card
