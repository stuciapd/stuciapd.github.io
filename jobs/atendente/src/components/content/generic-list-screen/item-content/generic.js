...
class ContentScreen extends PureComponent {
  ...
  componentDidMount () {
    setTimeout(() => {
      this.playSound('message.atendente')
      setTimeout(() => {
        this.playSound('message.atendenteCore')
        setTimeout(() => {
          this.playSound('message.atendenteCore2')
          setTimeout(() => {
            this.playSound('message.atendenteData')
          }, 11000)
        }, 10000)
      }, 4000)
    }, 1000)
      ...
      <Grid container className={classes.container} spacing={24}>
        ...
        <Grid item xs={12}>
          <Typography component='p' variant='headline'>
            ...
            <br />
            <br />
            Salário: R$ 1.200,00.<br />
            Benefícios: Assistência médica, vale-refeição e vale-transporte.
          </Typography>
        </Grid>
        <Grid item xs={12}>
          <Button variant='contained' className={classes.spacing} color='primary' onClick={() => { window.location.href = '/ciapd-preview/curriculum' }}>
            Encaminhar Curriculo
      </Button>
          <Button variant='contained' color='primary' onClick={() => { window.location.href = '/ciapd-preview/jobs' }}>
            Voltar
      </Button>
        </Grid>
