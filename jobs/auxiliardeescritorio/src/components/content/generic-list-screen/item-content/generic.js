...
class ContentScreen extends PureComponent {
  ...
  componentDidMount () {
    setTimeout(() => {
      this.playSound('message.auxiliar')
      setTimeout(() => {
        this.playSound('message.auxiliarCore')
        setTimeout(() => {
          this.playSound('message.auxiliarData')
        }, 16000)
      }, 5000)
    }, 1000)
  }
      ...
      <Grid container className={classes.container} spacing={24}>
        ...
        <Grid item xs={12}>
          <Typography component='p' variant='headline'>
            ...
            <br />
            <br />
            Salário: R$ 1.400,00.<br />
            Benefícios: Assistência médica e cesta básica.
          </Typography>
        </Grid>
        <Grid item xs={12}>
